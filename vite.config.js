...
import { createLogger, defineConfig, loadEnv } from 'vite'; // Adicionado loadEnv aqui
import react from '@vitejs/plugin-react';

// Plugins originais da Hostinger
import inlineEditPlugin from './plugins/visual-editor/vite-plugin-react-inline-editor.js';
import editModeDevPlugin from './plugins/visual-editor/vite-plugin-edit-mode.js';
import iframeRouteRestorationPlugin from './plugins/vite-plugin-iframe-route-restoration.js';
import selectionModePlugin from './plugins/selection-mode/vite-plugin-selection-mode.js';

// --- CÓDIGO DE ERRO DA HOSTINGER (MANTIDO INTACTO) ---
...
export default defineConfig(({ mode }) => {
	...
	// Recriamos o objeto addTransformIndexHtml aqui dentro para ele ter acesso às variáveis se precisar
