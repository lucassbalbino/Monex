  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] max-w-4xl mx-auto text-center space-y-8 p-8">
      ...
      >
        ...
        <div className="relative bg-[#1E293B] p-8 rounded-full border-2 border-[#14B8A6]/30 shadow-2xl">
      ...
      >
        ...
        <div className="bg-[#1E293B]/50 p-6 rounded-xl border border-[#14B8A6]/30 text-gray-300 leading-relaxed text-lg">
          <p>
      ...
      >
        <div className="bg-[#1E293B] p-4 rounded-lg border border-[#14B8A6]/30 opacity-60">
